...
<template>
  ...
  >
    ...
    <section
      ...
      aria-label="Étapes chronologiques du parcours"
    >
      ...
      >
        ...
        >
          ...
          <span class="etape-info">
            ...
            <span
              v-if="step.sources?.length || step.source"
    ...
    <section
      ...
      aria-label="Navigation GPS piétonne"
    >
      <button
        type="button"
        class="btn-gps-global"
        :disabled="!steps.length"
        @click="emit('gps', steps)"
      >
        {{
