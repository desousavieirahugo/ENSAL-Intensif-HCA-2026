  ...
  () =>
    person.value?.etapes
      ...
      .map((step, index) => ({
        ...step,
        markerKey: step,
        markerColor: person.value.color,
        index,
      })) || [],
)
...
const hasSearchQuery = computed(() => search.value.trim().length >= 2)
...
<template>
  <div class="application-shell">
    ...
    <a
      class="skip-link"
      href="#app"
      @click.prevent="openPerson('jean_moulin')"
    >
    ...
    >
      <div id="map-wrapper">
        ...
        <header
          class="app-header"
          aria-label="Navigation cartographique"
        >
          <div class="app-header-left">
            ...
            <div class="header-title-wrapper">
              ...
              <h1 class="header-context-title">
                {{ person?.nom || 'Lieux de Justice' }}
              </h1>
            </div>
          </div>
        ...
        >
          ...
          <div class="header-search-centered">
            ...
            <div
              ...
              class="active header-search-results search-results"
            >
              <button
            ...
            <p
              ...
              class="active header-search-results search-empty search-results"
              role="status"
            >
        ...
        <button
          v-if="sidebarOpen"
          type="button"
          class="active backdrop-overlay sidebar-backdrop-button"
          :style="
        ...
        <nav
          class="map-bottom-dock"
          aria-label="Contrôles cartographiques et étapes"
        >
          <div
            class="epoch-pills"
            role="group"
            aria-label="Choisir l’époque cartographique"
          >
            <button
